...
/*  A Bison parser, made from ch1-05.y
...
static const char * const yytname[] = {   "$","error","$undefined.","NOUN","PRONOUN",
"VERB","ADVERB","ADJECTIVE","PREPOSITION","CONJUNCTION","sentence","subject",
"object", NULL
};
#endif
