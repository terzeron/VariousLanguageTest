...
import net.localhorst.forrest.roo.example.domain.Person;
...
privileged aspect Person_Roo_Entity {
    ...
    @Column(name = "_id")
    private Long Person._id;
    
    @Version
    @Column(name = "version")
    private Integer Person.version;
    
    public Long Person.get_id() {
        return this._id;
    }
    
    public void Person.set_id(Long id) {
        this._id = id;
    }
    ...
    public void Person.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            Person attached = this.entityManager.find(Person.class, this._id);
